...
two independent detectors in Hanford, Washington and Livingston, Louisiana along
...
Construction of the Advanced LIGO (aLIGO) detectors~\cite{TheLIGOScientific:2014jea} 
...
computational improvements to the matched-filtering algorithm in Ch.~\ref{ch:opt}.
...
the significance of candidate events, and measure probabilities under the
...
single stage configuration proposed in Ch.~\ref{ch:single_stage}. Lastly,
