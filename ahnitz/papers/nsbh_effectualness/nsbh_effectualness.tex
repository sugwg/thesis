\documentclass[prd,twocolumn,lengthcheck,superscriptaddress,showpacs,letterpaper,nofootinbib,aps]{revtex4-1}
...
\title{Investigating the effect of precession on searches for
neutron-star--black-hole binaries with Advanced LIGO}

\author{Ian W.\ Harry}
%\email{iwharry@syr.edu}
...
\author{Andrew P.\ Lundgren}
%\email{andrew.lundgren@ligo.org}
...
\affiliation{Center for Gravitation and Cosmology, University of
Wisconsin-Milwaukee,
...
B.~S.~Sathyaprakash, Peter Saulson, Matt West and Karl Wette for useful 
discussions. We also thank Frank Ohme and the anonymous referee for providing 
thoughtful and insightful comments on this manuscript. This work is supported
by National Science Foundation awards PHY-0847611 (DAB, AHN), PHY-1205835
(AHN, IWH), PHY-0970074 (EO), PHY-0855589 (AL) and PHY11-25915 (DAB,IWH,EO,AL). 
