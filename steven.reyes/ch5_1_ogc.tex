...
A second observing run (O2) of the Advanced LIGO detectors took place from November 30, 2016 to August 25, 2017~\citep{Aasi:2013wya}.  The Virgo gravitational wave detector also collected data for part of this period, starting from August 1, 2017.  The detections reported in this second observing run thus far include three additional binary black hole coalescence events \citep{Abbott:2017vtc,Abbott:2017gyy,Abbott:2017oio}, and a binary neutron star merger \citep{TheLIGOScientific:2017qsa}. However, the full O2 data set has not yet been released. The catalog presented here is therefore restricted to the first observing run, O1.
...
\begin{figure}[h]
  \centering
    \includegraphics[width=\columnwidth]{bank.pdf}
...
\begin{figure}[h]
  \centering
    \includegraphics[width=\columnwidth]{pastro.pdf}
...
\begin{figure}[]
  \centering
    \includegraphics[width=\columnwidth]{candidates.pdf}
