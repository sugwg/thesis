...
\begin{equation}
 ...
 Using the above relation, ~\cite{Akcay:2012} provides a fit 
 formula for \(a(x)\) that  is valid over the range  \(0 < x < \frac{1}{3}\), 
 \begin{equation}
...
% \(0<x<\frac{1}{3}\). 
The corresponding self-force corrected energy and 
...
% 
We use a new prescription for the energy flux that uses the first-order
in mass ratio terms derived in~\cite{Fujita:2012}, which include PN 
corrections up to \(22^\mathrm{nd}\) PN order
\begin{eqnarray}
\label{enfluxpn}
