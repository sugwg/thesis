...
astrophysical processes and systems, like the physics of neutron stars, 
...
the weak field regime, and become especially increasingly inadequate in 
...
While Einstein's field equations are in a particularly difficult class of such
equations, it is possible to obtain fully numerical solutions for dynamical
...
simulations fo merging black holes by Pretorius in 
...
Pfeiffer~\cite{Pfeiffer:2012pc} for more details that can be provided within 
the scope of this dissertation. 

Most approaches in Numerical Relativity (NR) proceed by the ``3+1'' 
decomposition, or the foliation of spacetime into non-intersection spacelike
3-surfaces that can be thought of as level surfaces for a globally defined 
time function. The situation is qualitatively similar to classical 
electromagnetism. Maxwell equations can be written in the manifestly covariant
form as
%
\begin{align*}
\cd_\nu F^{\mu\nu} &= j^\mu \\
...
\end{align*}
%
where $F$ is the electromagnetic field strength tensor and $F*$ is its dual. 
