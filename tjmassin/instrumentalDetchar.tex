...
\caption[DAC glitches in PRCL]{A timeseries plot showing the effects of %
         DAC calibration glitches. The red trace shows the digital control%
...
Large glitches $h(t)$ were driving the X-arm ETM control signal through a value of 
...
$h(t)$, as a function of the length of the input mode cleaner \cite{Nuttal:2015dqa}. 
The length of 
