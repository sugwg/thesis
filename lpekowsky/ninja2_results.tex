...
\begin{figure}
  \includegraphics[width=0.5\linewidth]{figures/ninja2_results/H_second_high_mass_efficiency}
  \includegraphics[width=0.5\linewidth]{figures/ninja2_results/L_second_high_mass_efficiency} \\
  \includegraphics[width=0.5\linewidth]{figures/ninja2_results/V_second_high_mass_efficiency}
...
\begin{figure}
  \includegraphics[width=0.5\linewidth]{figures/ninja2_results/H_second_high_spin_efficiency}
  \includegraphics[width=0.5\linewidth]{figures/ninja2_results/L_second_high_spin_efficiency} \\
  \includegraphics[width=0.5\linewidth]{figures/ninja2_results/V_second_high_spin_efficiency}
  \caption[Efficiency of the high-mass pipeline as a function of mass]{
...
\begin{figure}
  ...
  \label{f:ninja2_cbc_results_high_second}
Preliminary second stage (after coincidence and $\chisq$) found/missed plots from
the low-mass search.  As expected, many of the signals reported as
``found'' after the first stage were due to background triggers within
100 ms of the injection.  More signals are missed at higher masses
because the high-mass bank only extends to $100 \msun$ but there are
injections up to $350 \msun$.  There is an anomaly in the Virgo
...
\begin{figure}
  \includegraphics[width=0.5\linewidth]{figures/ninja2_results/H_second_low_mass_efficiency}
  \includegraphics[width=0.5\linewidth]{figures/ninja2_results/L_second_low_mass_efficiency} \\
  \includegraphics[width=0.5\linewidth]{figures/ninja2_results/V_second_low_mass_efficiency}
...
\begin{figure}
  \includegraphics[width=0.5\linewidth]{figures/ninja2_results/H_second_low_spin_efficiency}
  \includegraphics[width=0.5\linewidth]{figures/ninja2_results/L_second_low_spin_efficiency} \\
  \includegraphics[width=0.5\linewidth]{figures/ninja2_results/V_second_low_spin_efficiency}
  \caption[Efficiency of the high-mass pipeline as a function of mass]{
