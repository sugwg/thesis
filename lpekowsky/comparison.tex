...
frequencies are small.  Frequently the cutoff is taken to be the
...
the merger may even occur in the sensitive band.  It is therefore
...
(eqn.~\ref{eq:OverlapDefinition}).  Clearly if no instance of a
