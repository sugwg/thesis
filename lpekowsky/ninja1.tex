...
table~\ref{inspiral_results} compare the pipeline used in the S5
search (with a mass range extended to cover the range of injections)
to the pipeline with all our recommendations implemented.  By doing
...
ability to draw definitive conclusions.  The limitation on mass at
which waveforms could be injected certainly limits out ability to 
make statements on a low-mass search.
