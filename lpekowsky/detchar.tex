...
be {\code trigbank} instances; this is the step where triggers from
...
after clustering.  A {\code trigbank} instance processing this time was
unable to complete.
...
In addition to identifying glitchy times, daily ihope was used to
identify 

\begin{figure}
  \includegraphics[width=0.5\linewidth]{figures/detchar/20090806_H1_0_UNCLUSTERED_template_counts}
  \caption[Problematic template identified by daily ihope]{
...
\iffalse
http://ilog.ligo-wa.caltech.edu/ilog/pub/ilog.cgi?group=detector&date_to_view=08/02/2010&anchor_to_scroll_to=2010:08:02:19:23:12-lundgren
https://ldas-jobs.ligo.caltech.edu/~cbc/ihope_daily/201007/20100724/
