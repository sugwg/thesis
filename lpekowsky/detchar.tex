...
\Note{TODO: flowchart of the daily ihope pipeline}
...
(section~\ref{ssec:ihope_hardware_injections}).  In the full analysis
...
section~\ref{ssec:ihope_hardware_injections} it was known at the start
