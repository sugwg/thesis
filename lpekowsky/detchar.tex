...
In Sec.~\ref{sec:daily_ihope} we introduce the daily ihope
...
described in Sec.~\ref{ssec:analysis_trigger_selection}. For each
...
SNR.  As noted in Sec.~\ref{sec:ihope_match_filter}, in Gaussian
...
Similarly Fig.~\ref{f:daily_ihope_gaussianity_newsnr} shows histograms
...
Fig.~\ref{f:hipe}); this is the step where triggers from the first
...
Sec.~\ref{sec:search_pipeline} it was known at the start
