...
charactarization group would work with the commissioners to identify
...
{\it Glitches from the Thermal Compensation System}
...
This is now considered solved. After tracking it to an electronics glitch somewhere near the OMC, a resoldering of the PZT power supply seems to have fixed the problem. 
...
The calculation takes three samples each a half-millisecond apart, and
just does $x[0] - 2 x[1] + x[2]$
...
\begin{figure}
  \includegraphics[width=\linewidth]{figures/detchar/20100106_L1_0_UNCLUSTERED_snr_vs_time} \\
  \includegraphics[width=\linewidth]{figures/detchar/946834715_499755859_L1_LSC-DARM_ERR_1_00_spectrogram_whitened} \\
...
\noindent {\it Use-percentage vetoes}
