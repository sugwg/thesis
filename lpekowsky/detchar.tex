...
(Smith and Lundgren in progress).  Three primary tools were run either
...
full analysis every two weeks with latencies as small as possible.
...
the mirror through radiation pressure and producing loud noise in the
detector.
