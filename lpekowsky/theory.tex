...
pairs of neutron stars and/or black holes.  These are analytic models,
discussed in section~\ref{sec:PNWaveforms} and numerical models,
discussed in section~\ref{sec:NRWaveforms}.
...
singularity from the computational grid.
...
frequency range to which LIGO is most sensitive.  We therefore
