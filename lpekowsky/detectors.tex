...
\emph{glitches}, short transient events which can have detrimental
effects on searches.  Some glitches may be characterized in \darmerr
as multiple relatively small excursions from the mean (``popcorn
noise'' or ``grumbly times''), others are single large excursions
(``bangs''), and others have a wide variety of other characteristics.
There are likewise numerous causes of glitches, some are reactions to
external environmental conditions and others are internal to the
detector.  Chapter~\ref{ch:segdb} will present the infrastructure used
