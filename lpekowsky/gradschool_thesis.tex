...
% The abstract is page 1, but not shown, so don't
% bother setting up the counter
...
% We do "afterpreface" before the preface
% because the grad school wants the list of figures
% before the preface material.  DERP!
...
\iffalse
% The grad school will complain about copyright if this is left in.
\vspace*{0.5cm}
...
\birthplacedate{New York, New York \>\>December 16, 1966}
\collegewherewhen{
\>New York University \>\>B.A Computer Science, 1988 \\
\>Yale University  \>\>M.S. Computer Science, 1991 \\
\>SUNY Stony Brook \>\>B.S. Physics, 2006\\
}
...
2006 \>Golden Key \\
2006 \>Sigma Pi Sigma \\
2006 \>Syracuse University Fellowship\\
