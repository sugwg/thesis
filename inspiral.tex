...
\end{equation}
and substituting this into equation (\ref{eq:afourth}) to obtain
\begin{equation}
...
\begin{align}
\label{eq:coschirp}
h_c(t) & = \frac{2}{c^2}\left(\frac{\mu}{M_\odot}\right) \left[\pi G M f(t)\right]^{\frac{2}{3}} \cos(2\pi f(t) t - 2\phi_0), \\
h_s(t) & = \frac{2}{c^2}\left(\frac{\mu}{M_\odot}\right) \left[\pi G M f(t)\right]^{\frac{2}{3}} \sin(2\pi f(t) t - 2\phi_0),
\label{eq:sinechirp}
\end{align}
