...
A linearly polarized gravitational wave is one that only contains the plus or
...
Is it possible to measure a phase shift of $10^{-10}$ using a
...
As the phase of the gravitational wave changes through a complete cycle, the
rings are disorted in the manner shown.
}
\end{figure}
...
\end{center}
\caption[Antenna Response of an Interferometer to Unpolarized Waves]{%
The response of an interferometer to unpolarized gravitational waves.
}
\end{figure}
