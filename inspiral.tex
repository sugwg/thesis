...
respect to the coordinate $x^\mu$. Consider two particles $A$ and $B$, as
...
and $x^i$ are the three Cartesian coordinates. Then in the LLF of particle $A$ 
the equation of geodesic deviation becomes
\begin{equation}
...
\frac{d^3 \mathcal{I}^\mathrm{TT}_{jk}}{dt^3}
\right\rangle = \frac{32G}{5c^5} \frac{M^3 \mu^2}{a^5}
\end{equation}
and so the inspiral rate for circular orbits is given by
\begin{equation}
\frac{da}{dt} = \frac{dE}{dt}\frac{da}{dE} = - \frac{64}{5c^5}\frac{\mu
M^2}{a^3}.
\end{equation}
The evolution of $a$ as a function of time can therefore be obtained by
integrating
\begin{align}
a^3 \, da &= - \frac{64}{5c^5} \mu M^2 \, dt \\
\frac{a^4}{4} &= \frac{64}{5c^5} \mu M^2 (t_c - t)
\end{align}
and so
\begin{equation}
a(t) = \left(\frac{256}{5c^5} \mu M^2 \right)^{\frac{1}{4}}
...
wave frequency $f(t)$ can be obtained by writing Kepler's third law as
\begin{equation}
a = \left(GM\right)^{\frac{1}{3}} \Omega^{-\frac{2}{3}}
\end{equation}
and substituting this into equation (\ref{eq:aoft}) to obtain
\begin{equation}
\left(GM\right)^{\frac{3}{4}} \Omega^{-\frac{8}{3}} 
= \frac{256}{5c^5}\eta M^4 \frac{(t_c - t)}{M},
\end{equation}
where we have defined $\eta = \mu / M$. From this, we may obtain
\begin{equation}
\Omega^{-\frac{8}{3}} = 
\frac{256}{G^\frac{1}{3} c^8} M^\frac{8}{3} \frac{c^3 \eta}{5GM}(t_c - t).
\end{equation}
...
then we obtain
\begin{equation}
\Omega^{-\frac{8}{3}} = \left(\frac{8M}{G^{\frac{1}{8}} c^3}\right)^\frac{8}{3}
\Theta(t)
\end{equation}
which written in terms of the gravitational wave frequency $f = \Omega / \pi$
is
\begin{equation}
f(t) = \frac{G^\frac{1}{8} c^3}{8\pi M} \left[\Theta(t)\right]^{-\frac{3}{8}}.
\end{equation}
We define the \emph{cosine chirp} $h_c$  and the \emph{sine chirp} $h_s$ as 
\begin{align}
\label{eq:coschirp}
h_c(t) & = \frac{2}{c^2}\mu (\pi G M f(t))^{\frac{2}{3}} \cos(2\pi f(t) t - 2\phi_0), \\
h_s(t) & = \frac{2}{c^2}\mu (\pi G M f(t))^{\frac{2}{3}} \sin(2\pi f(t) t - 2\phi_0),
\label{eq:sinechirp}
\end{align}
so that the $+$ and $\times$ waveforms are
\begin{align}
\label{eq:hpluswave}
h_+(t) &= - \frac{G}{c^2 r} (1 + \cos^2\iota) h_c(t), \\
h_\times(t) &= - \frac{2G}{c^2 r} \cos\iota h_s(t).
\end{align}
