...
\times 10^{11}$ PBHs in the halo.  Such $\sim 1\,M_\odot$ BHMACHOs are formed
when the age and temperature of the universe is $\sim 10^{-5}$~seconds and
$\sim 1$~GeV, respectively. If there are such a large number of BHMACHOs in
the halo, it is natural to assume that some of these may be in binary systems.
Nakamura~\emph{et~al.} showed that the distribution of the semi-major axis,
$a$, and eccentricity, $e$ of binary BBHMACHOs is
\begin{equation}
f(a,e)\, da\, de = 
\frac{ 3ea^{\frac{1}{2}} }
...
\end{equation}
where $h$ is the Hubble parameter in units of $100$~km~s$^{-1}$. The coalescence time of a
