...
Nakamura~\emph{et~al.}\cite{Nakamura:1997sm} considered PBHs formed when the
...
\end{center}
\caption[Spatial Distribution of Binary Black Hole MACHOs in Galactocentric
Coordinates]{%
...
\end{center}
\caption[Spatial Distribution of Binary Black Hole MACHOs Seen From Earth]{
