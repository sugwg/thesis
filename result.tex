...
\begin{figure}[p]
\begin{center}
\includegraphics[width=0.6\linewidth]{figures/result/s2_times}
\end{center}
...
\begin{table}[p]
\begin{tabular}{cllr}
Parameter & Description & Pipeline node & value \\
\hline 
$f_\mathrm{hp}$ & High Pass Filter Frequency & Bank generation and inspiral search & $100$~Hz \\
$O_\mathrm{hp}$ & High Pass Filter Order & Bank generation and inspiral search & $100$~Hz \\
$f_\mathrm{low}$ & Low Frequency Cutoff & Bank generation and inspiral search & $100$~Hz \\
$m_\mathrm{min}$ & Template bank lower component mass & Bank generation & $0.2\,M_\odot$ \\
$m_\mathrm{max}$ & Template bank upper component mass & Bank generation & $1.0\,M_\odot$ \\
$\mathbb{M}$ & L1 template bank minimal match & Bank generation & 0.95 \\
$\rho^\ast_\mathrm{L1}$ & Signal-to-noise ratio threshold & L1 inspiral search & 7.0 \\
$\Xi^\ast_\mathrm{L1}$ & $\chi^2$ veto threshold & L1 inspiral search & 3.1 \\
$\rho^\ast_\mathrm{H1}$ & Signal-to-noise ratio threshold & H1 triggered inspiral search & 7.0 \\
$\Xi^\ast_\mathrm{H1}$ & $\chi^2$ veto threshold & H1 triggered inspiral search & 5.0 \\
$\rho^\ast_\mathrm{H2}$ & Signal-to-noise ratio threshold & H2 triggered inspiral search & 7.0 \\
$\Xi^\ast_\mathrm{H2}$ & $\chi^2$ veto threshold & H2 triggered inspiral search & 10.0 \\
$p$ & Number of bins in $\chi^2$ veto & L1,H1,H2 inspiral search & 15 \\
$\delta^2$ & Mismatch paramater in $\chi^2$ veto & L1,H1,H2 inspiral search & 0.2 \\

$\delta m$ & Mass coincidence parameter & Trigger Coincidence & 0.0 \\
$\delta t$ & Time coincidence parameter & H1-H2 Trigger Coincidence & 0.001 s \\
$\delta t$ & Time coincidence parameter & L1-H1 and L1-H2 Trigger Coincidence & 0.011 s \\
$\kappa_{HH}$ & Amplitude coincidence parameter & H1-H2 Trigger Coincidence & 0.5 \\
$\kappa_{LH}$ & Amplitude coincidence parameter & L1-H1 and L1-H2 Trigger Coincidence & 1000.0 \\
$\epsilon$ & Amplitude coincidence parameter & Trigger Coincidence (all) & 2
\end{tabular}
...
vertical red lines show the edge of the template bank parameters space. Notice
