...
The raw output of the inteferometer is the error signal from the length
...
The value of \ospsd for white Gausian noise will be useful to us later, so we
...
$\tilde{h}_{ck} \equiv {h}_c(f_k) / \Delta t\$.
