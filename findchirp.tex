...
Returning to the discussion of the Neyman-Pearson optimal receiver, it can be
...
Now compute $\chi^2$.  We can ignore the $v$ terms.  Thus
\begin{equation}
\begin{split}
...
\textcolor{red}{This algorithm needs to be checked}
\begin{enumerate}
