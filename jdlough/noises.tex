...
\begin{figure}
  ...
  \begin{loglogaxis}[
    ...
    \addplot[green,very thick] table[x index=0,y index=2]
      {./matlab_traces/thermalnoises.dat};
    \addplot[magenta,very thick] table[x index=0,y index=5]
      {./matlab_traces/thermalnoises.dat};
    \addplot[yellow,very thick] table[x index=0,y index=4]
      {./matlab_traces/thermalnoises.dat};
  ...
  \end{loglogaxis}
  \end{tikzpicture}
  \caption[Thermal Noise Sources]{thermal noise contributions to experiment.}
...
%    width=14cm,
    xlabel={Frequency $\left[\mathrm{Hz}\right]$},
    ylabel={Trap Length Noise $\left[m/\sqrt{\mathrm{Hz}}\right]$},
    xmin=10,
    xmax=6000,
    ymin=1e-16,
    ymax=1e-8,
