...
E_{\mathrm{reflected}} =& E_{\mathrm{incident}} \left( 1-r_1^2 \right)
    \left( \frac{r_1 r_2 e^{i \omega 2L/c}}{1 - r_1 r_2 e^{i \omega 2L/c}} \right)
    - r_1 E_{\mathrm{incident}}\\
E_{\mathrm{reflected}} =& r_1 E_{\mathrm{incident}} \left[
    \frac{(1 - r_1^2) r_2 e^{i \omega 2L/c}}{1 - r_1 r_2 e^{i \omega 2L/c}} -1 \right]
\end{align}
