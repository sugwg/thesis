...
\begin{tikzpicture}
  ...
  \node[mirror] (m1) at (-2.5,5.5) {};
  \node[aom,rotate=-5] (aom2) at (-2,9) {AOM};
  \node[bblock,rotate=-10] (bb2) at (-1.5,12.5) {};
  \node[eom] (eom1) at (-2,26) {EOM};
  \node[mirror] (m2) at (-2,30) {};
  \node[mirror] (m3) at (-7,30) {};
  \node[mirror] (m4) at (-12,30) {};
  \node[mirror] (m5) at (-12,33) {};
  \node[pbs] (pbs2) at (-14,33) {PBS};
  \node[mirror] (m6) at (-18,33) {};
  \node[mirror] (m7) at (-18,38) {};
  \node[mirror] (m8) at (-14,38) {};
  \node[mirror] (m9) at (-7,36) {};
  \node[pbs] (pbs3) at (-24,36) {PBS};
  \node[mirror] (m10) at (-24,40) {};
  \node[rfpd] (rfpd1) at (-32,40) {RFPD};
  \node[mirror] (mrefl21) at (-27,38) {};
...
\\  P_{\mathrm{trans}}  &= P_{\mathrm{incident}} \frac{4}{ \left( w_{c0} /
    w_{b0} + w_{b0} / w_{c0} \right)^2 + \left( \lambda z_0 / z_R \right)^2}
    \label{symetricmatch}
\end{align}
