...
active feedback.
In ordet to do this we need to measure the control signal while locked with
a stable spring.
...
We want this to be significantly less than the stability range as defined in
section \ref{sec:III}.
...
\begin{figure}
  ...
  \caption[Parameter Space for 2nd Edition]{the parameter space of the
    experiment.
    We can see the stability values for different detunings.
...
At higher frequencies, the noise entering the system is lower.
