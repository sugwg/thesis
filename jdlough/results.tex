...
In order to observe the optical spring effect and measure it
...
bounded input. In the case of a spring attached to a mass, if we apply a finite
motion to the end of the spring opposite the mass, the motion of the mass must
grow indefinitely. For us, our mass is a small mirror at one end of an optical
spring cavity.
...
A system which is linear and time invariant will multiply a sinusoidal input
...
\begin{table}
  \begin{center}
    ...
    \begin{tabular}{|l|l|l|}
      \hline
      Measurement ID & Error point offset $[\mathrm{mV}]$ & Resonant Frequency [Hz] \\
      \hline
      \hline
      30 & -604  & 742 \\
      \hline
...
The optical spring basically has four parameters that can change during the
...
The measurement parameters and spring frequencies can be seen in table
