...
Corbitt, et al. with an additional degree of freedom.
...
and $R$ for the power reflectivity. I will also use $R$ for radius of
curvature, but the distinction will be apparent in the context.
